...
class UserRegistrationForm(UserCreationForm):
      ...
      def save(self, commit = True):
            ...
            if commit == True:
                  ...
                  # creating objects for bank account
      ...
      # Adding css from forms. As adding css from backend
...
# For updating user existing data
class UserUpdateForm(forms.ModelForm):
      ...
      def save(self, commit = True):
            ...
            if commit:
                  ...
                  # Using of get_or_create means if user exists ?
